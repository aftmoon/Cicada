...
public class CardVisual : MonoBehaviour
{
    ...
    public Disslove DissloveEffect;
    ...
    {
        CardName.text = target.name;
        parentCard = target;
        cardTransform = target.transform;
        canvas = GetComponent<Canvas>();
        shadowCanvas = visualShadow.GetComponent<Canvas>();
        
        parentCard.BeginDragAction += BeginDrag;
        parentCard.EndDragAction += EndDrag;
        parentCard.PointerEnterAction += PointerEnter;
        parentCard.PointerExitAction += PointerExit;
        parentCard.PointerUpAction += PointerUp;
        parentCard.PointerDownAction += PointerDown;
        parentCard.SelectAction += Select;
    ...
    void Update()
    {
        FollowRotation();
        CardTilt();
        if (!inited || parentCard == null) return;
        HandPositioning();
        SmoothFollow();
    ...
    private void CardTilt()
    {
        ...
        Vector3 offset = transform.position - mainCam.ScreenToWorldPoint(Input.mousePosition);
