...
public class Jaeger_Attrat : MonoBehaviour
{
    ...
    internal bool leftControl_KeyDown;
    ...
    void Update()
    {
        ...
        //TODO!  ccc左边ctrl键坏了哈哈
        leftControl_KeyDown = Input.GetKeyDown(KeyCode.RightControl);
        Q_KeyDown = Input.GetKeyDown(KeyCode.Q);

        //leftControl_KeyDown = Input.GetKeyDown(KeyCode.LeftControl);
        bool input_attact = leftControl_KeyDown | leftMouse_KeyDown | Q_KeyDown;
...
public class NormalAttact02 : ActionState
{
    ...
    public override void HandleInput()
    {
        ...
        {
            if (playerC.leftControl_KeyDown)
                playerC.specialAttact.Enter();
        }
...
public class IdleState: ActionState
{
    ...
    public override void HandleInput()
    {
        ...
        if (playerC.leftMouse_KeyDown)
            ...
            playerC.specialAttact.Enter();
        if (playerC.Q_KeyDown && playerC.CanDodge(0,0))
        {
            playerC.dodge.Enter();
        }
    }
